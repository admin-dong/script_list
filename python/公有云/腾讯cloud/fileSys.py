...
def post_flieSys(sign):
        url = "https://cfs.tencentcloudapi.com/"
        header = {
            "Content-Type":"application/json",
            "X-TC-Action":"DescribeCfsFileSystems",
            "X-TC-Version":"2019-07-19",
            "X-TC-Region":region,
...
if __name__ == '__main__':
    params = {"Limit":100,"Filters":[{"Values":["ap-shanghai-2","ap-shanghai-1"],"Name":"zone"}],"Offset":0}
    parser = OptionParser()
