...
def parse_service_instance(content, vcenter_host,netZone):
    ...
    for obj in object_view.view:
        ...
        try:
            ...
            if hasattr(obj.config, 'datastoreUrl'):
            ...
            if hasattr(obj.config, 'createDate'):
            ...
            if hasattr(obj.summary.runtime.host, 'name'):
            ...
            if obj.guest.guestFamily != None:
                ...
                if obj.config.guestFullName != None and obj.config.guestFullName != '':
                    data['osVersion'] = obj.config.guestFullName
